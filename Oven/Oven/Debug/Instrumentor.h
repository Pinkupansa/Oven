...
#define OVEN_PROFILE 1
    ...
    #define OVEN_PROFILE_FUNCTION() OVEN_PROFILE_SCOPE(OVEN_FUNCSIG)
#else 
    #define OVEN_PROFILE_BEGIN_SESSION(name, filepath)
    #define OVEN_PROFILE_END_SESSION()
    #define OVEN_PROFILE_SCOPE(name)
    #define OVEN_PROFILE_FUNCTION() 
#endif