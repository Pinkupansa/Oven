...
static std::string getOpenGLErrorMessage(GLenum error)
{
    switch (error)
    {
        case GL_INVALID_OPERATION:
            return "GL_INVALID_OPERATION: texture shader is not bound!";
        case GL_INVALID_ENUM:
            return "GL_INVALID_ENUM: invalid enum value passed.";
        case GL_INVALID_VALUE:
            return "GL_INVALID_VALUE: invalid parameter value.";
...
template <typename F> auto glCallImpl(F&& func, const char* expr)
{
