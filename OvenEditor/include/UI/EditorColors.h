...
#define COLOR_ACCENT_CYAN ImVec4(0.000f, 0.643f, 0.894f, 1.00f)         // Primary Focus / Selection Accent
#define COLOR_ACCENT_ORANGE ImVec4(1.000f, 0.400f, 0.000f, 1.00f)       // Secondary Highlight / Active State Accent
...
#define COLOR_HOVER_CYAN ImVec4(0.318f, 0.769f, 0.929f, 1.00f)          // Interactive Hover Highlight
